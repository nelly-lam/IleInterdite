...
public class PantonFont {
    ...
    public static Font getPanton() {
        try {
            FileInputStream filePanton = new FileInputStream("src/bl/fonts/Panton-Regular.ttf");
    ...
    public static Font getPantonLight() {
        try {
            InputStream filePantonLight = new FileInputStream("src/bl/fonts/Panton-Light.ttf");
    ...
    public static Font getPantonBold() {
        try {
            FileInputStream filePantonBold = new FileInputStream("src/bl/fonts/Panton-Bold.ttf");
